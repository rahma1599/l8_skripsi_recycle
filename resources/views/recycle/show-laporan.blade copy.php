            ...
            <div class="col-md-6">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="basic-layout-form">Laporan Recycle</h4>
                    ...
                    <form method="POST" action="" class="form" novalidate>@csrf
                      <div class="form-body">
                        <div class="form-group">
                            <label for="companyName">Jenis Laporan</label>
                              <label for=""></label>
                              <select multiple class="form-control" name="jenis_laporan" id="jenis_laporan">
                                <option>Belum Potong</option>
                                <option>Tunggu Buffing</option>
                                <option>Siap Pouring</option>
                              </select>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
